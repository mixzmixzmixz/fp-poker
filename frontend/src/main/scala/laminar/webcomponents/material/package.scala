 ...
 */
package laminar.webcomponents.material {
   ...
   *
   * {@literal @material/mwc-checkbox@0.25.3}
   *
   ...
   *
   * {@literal @material/mwc-circular-progress@0.25.3}
   *
   ...
   * Progress indicators express an unspecified wait time or display the length of a process.
   *
   * {@literal @material/mwc-circular-progress-four-color@0.25.3}
   *
   ...
   *
   * {@literal @material/mwc-drawer@0.25.3}
   *
   ...
   *
   * {@literal @material/mwc-fab@0.25.3}
   *
   ...
   *
   * {@literal @material/mwc-formfield@0.25.3}
   *
   ...
   *
   * {@literal @material/mwc-icon-button-toggle@0.25.3}
   *
   ...
   *
   * {@literal @material/mwc-icon@0.25.3}
   *
   ...
   * Progress indicators express an unspecified wait time or display the length of a process.
   *
   * {@literal @material/mwc-linear-progress@0.25.3}
   *
   ...
   *
   * {@literal @material/mwc-radio@0.25.3}
   *
   ...
   *
   * {@literal @material/mwc-snackbar@0.25.3}
   *
   ...
   *
   * {@literal @material/mwc-switch@0.25.3}
   *
   ...
   *
   * {@literal @material/mwc-tab-bar@0.25.3}
   *
  ...
  object TabBar {
     ...
     * Tabs organize content across different screens, data sets, and other interactions.
     *
     * {@literal @material/mwc-tab@0.25.3}
     *
   ...
   *
   * {@literal @material/mwc-list@0.25.3}
   *
   * @see <a href="https://github.com/material-components/material-components-web-components/tree/master/packages/tab-bar">Component Documentation</a>
   */
  object List {
   ...
   *
   * {@literal @material/mwc-menu@0.25.3}
   *
  ...
  object Textfield {
    ...
    object styles {
       ...
       * @see <a href="https://github.com/material-components/material-components-web-components/tree/master/packages/textfield">Component Documentation</a>
       */
      val textFieldOutlinedHoverBorderColor = new ReactiveStyle(new Style("--mdc-text-field-outlined-hover-border-color"))
       ...
       * @see <a href="https://github.com/material-components/material-components-web-components/tree/master/packages/textfield">Component Documentation</a>
       */
      val textFieldOutlinedDisabledBorderColor = new ReactiveStyle(new Style("--mdc-text-field-outlined-disabled-border-color"))
  ...
  object Textarea {
    ...
    object styles {
       ...
       * @see <a href="https://github.com/material-components/material-components-web-components/tree/master/packages/textarea">Component Documentation</a>
       */
      val textAreaOutlinedDisabledBorderColor = new ReactiveStyle(new Style("--mdc-text-area-outlined-disabled-border-color"))
   ...
   *
   * {@literal @material/mwc-select@0.25.3}
   *
  ...
  object Select {
    ...
    object styles {
       ...
       * @see <a href="https://github.com/material-components/material-components-web-components/tree/master/packages/select">Component Documentation</a>
       */
      val selectOutlinedDisabledBorderColor = new ReactiveStyle(new Style("--mdc-select-outlined-disabled-border-color"))
   ...
   *
   * {@literal @material/mwc-top-app-bar-fixed@0.25.3}
   *
   ...
   *
   * {@literal @material/mwc-top-app-bar@0.25.3}
   *
